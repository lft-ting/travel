...
<script type="text/javascript">
    /* function location(){
		window.location.href='city.jsp?provinceid = ${provinceid}';
	} */
...
<body>
	...
	<section class="padding-t-b-60px bg-img1">
		<div class="margin-bottom-40px">
			<div class="hainan-d">
				...
				<c:if test="${not empty province.imagePath}">
					<div class="hai-d hai-h">
						<a href='<%=basePath%>ScenicServlet/selectCity?provinceid=${province.provinceId}' title="${province.provinceName}">
							<img src="${province.imagePath}" alt="" height="177px">
							<div class="detail1">
								<div class="title9 t">${province.provinceName}</div>
								<div class="title2 t2">Sanya</div>
							</div>
						</a>
					</div>
				</c:if>
	...
	<section class="padding-t-b-60px">
		<div class="hainan-d  hai-h">
			<h2 class="margin-bottom-10px">精选酒店  Hotels</h2>
			<div class="margin-bottom-40px">
				<div class="hotel-l">
